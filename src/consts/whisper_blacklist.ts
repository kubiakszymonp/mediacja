export const WHISPER_BLACKLIST = {
  en: ["www.mooji.org"],
  nl: [
  ...
  ru: ["Редактор субтитров А.Синецкая Корректор А.Егорова"],
  tr: ["Yorumlarınızıza abone olmayı unutmayın."],
  su: ["Sottotitoli creati dalla comunità Amara.org"],
  zh: ["字幕由Amara.org社区提供", "小編字幕由Amara.org社區提供"],
};

export const polishBlacklist = WHISPER_BLACKLIST.pl;
